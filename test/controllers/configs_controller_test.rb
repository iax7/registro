...
class ConfigsControllerTest < ActionController::TestCase
  ...
  test "should create config" do
    assert_difference('Config.count') do
      post :create, config: { allocationcost: @config.allocationcost, allocationdeadline: @config.allocationdeadline, foodcost: @config.foodcost, fooddeadline: @config.fooddeadline }
    end
  ...
  test "should update config" do
    patch :update, id: @config, config: { allocationcost: @config.allocationcost, allocationdeadline: @config.allocationdeadline, foodcost: @config.foodcost, fooddeadline: @config.fooddeadline }
    assert_redirected_to config_path(assigns(:config))
  end
